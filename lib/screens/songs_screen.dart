...
import 'package:pbox/screens/tvshow_screen.dart';
              ...
              Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage(Assets.songsBackground),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          ...
                          color: Color.fromARGB(255, 10, 80, 230),
                          border: Border.all(
                            color: Colors.white,
                            width: 2,
                          ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Icon(Icons.tv),
                        style: ElevatedButton.styleFrom(
                            primary: Color.fromARGB(255, 238, 234, 4)),
                      ),
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
